function bucksMakeGraphs(error, data) {
// charts
...
time_chart
    ...
    .elasticX(true)
    .xAxisLabel("Date")
    .yAxisLabel("Completed applications")
...
function bucksAbandonGraphs(error, data) {
// charts
...
function bucksChannelGraphs(error, data) {
// charts
...
function bucksRejectedGraphs(error, data) {
// charts
...
function bucksMetricsGraphs(error, data) {
